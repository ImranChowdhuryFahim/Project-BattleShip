...
public class BattleShip extends ShipImp {

    @Override
    public String shipType() {
        return ShipImp.typeBattleShip;
    }

    @Override
    public int shipSize() {
        return ShipImp.sizeBattleShip;
    }

    @Override
    public int shipQuantity() {
        return ShipImp.quantityBattleShip;
    }
