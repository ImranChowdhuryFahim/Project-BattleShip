...
public class PatrolBoat extends ShipImp{

    @Override
    public String shipType() {
        return ShipImp.typePatrolBoat;
    }

    @Override
    public int shipSize() {
        return ShipImp.sizePatrolBoat;
    }

    @Override
    public int shipQuantity() {
        return ShipImp.quantityPatrolBoat;
    }
